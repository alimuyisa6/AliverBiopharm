...
async function getPaperReviews(req, res, ctx) {
  ...
  if (error) throw new SecurityError('Failed to fetch reviews', 500);
...
async function ratePaper(body, res, ctx) {
  ...
  if (error) throw new SecurityError('Failed to rate paper', 500);
...
async function deleteReview(body, res, ctx) {
  ...
  if (error) throw new SecurityError('Failed to delete review', 500);
