...
// Returns every registered site user (not just admins), merged with admin
// role and any active restriction — this is what the dashboard's Users
// page actually needs. Previously the frontend called get_all_site_sections
// by mistake, which is a CMS content store and has nothing to do with users.
