 import { supabase, parseCookies, hashToken, getClientIp, verifyTurnstile, generateSessionToken, generateCsrfToken } from './core.js';
...
function setSessionCookie(res, token) {
  res.setHeader('Set-Cookie', `session=${token}; HttpOnly; Secure; SameSite=Lax; Max-Age=${7 * 24 * 60 * 60}; Path=/`);
}
