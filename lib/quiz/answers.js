/* lib/quiz/answers.js */
import { supabase, recordWeakConcept, updateSpacedRepetition } from '../../core.js';
import {
  requireAuth,
  SecurityError,
  rateLimiter
...
import { validateOption, getSessionQuestionIds } from './validation.js';
...
export async function submitAnswer(body, res, ctx) {
  ...
  if (!isCorrect) {
    const conceptName = question.concept_name || question.subtopic || question.topic || question.learning_objective || null;
