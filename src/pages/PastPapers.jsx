    ...
    <div className="past-papers-page">
      <div className="past-papers-hero">
        <div className="past-papers-hero-inner">
          <div className="past-papers-hero-content">
            <span className="past-papers-eyebrow font-mono">
            ...
            <nav className="breadcrumb font-mono">
              ...
              <span className="font-maven-pro">Past Papers</span>
            </nav>

            <div className="past-papers-meta">
              <span className="past-papers-meta-item font-source-sans">
                <strong className="font-poppins">{total}</strong> papers
              </span>
      ...
      >
        {!user && (
          ...
          >
            <Icon name="lock" /> <span className="font-source-sans">Sign in to download papers. You can browse freely.</span>
          </div>
        )}
        ...
        {activeTab === 'all' && (
          <div className="past-papers-toolbar">
            ...
            <p className="past-papers-count font-source-sans">
              {papersLoading ? (
                'Loading papers...'
              ) : (
                <>
        ...
        {showPresets && activeTab === 'all' && user && (
          <div className="past-papers-presets">
            {presets.length === 0 ? (
              <p className="past-papers-presets-empty font-open-sans">
              ...
              presets.map((preset) => (
                ...
                >
                  <button
                    className="past-papers-preset-apply font-source-sans"
                    onClick={() =>
                ...
                <div className="card-body">
                  ...
                  {paper.avg_rating > 0 && (
                    <div className="paper-rating-stars">
                      ...
                      <span className="paper-rating-count-small font-mono">
                  ...
                  <div className="paper-card-chips">
                    {paper.level && (
                      <span className="chip font-maven-pro">
                        {paper.level}
                      </span>
                    )}
                    ...
                    {paper.paper_type && (
                      <span className="chip chip-primary font-maven-pro">
                        {paper.paper_type}
                      </span>
                    )}
                    ...
                    {downloadedIds.has(paper.id) && (
                      <span className="chip chip-success font-comfortaa">
        ...
        >
          ...
          >
            <div className="paper-modal-header">
              <div>
                <h2 className="paper-modal-title font-poppins">
                  {selectedPaper.title}
                </h2>
            ...
            <div className="paper-modal-body">
              ...
              <div className="paper-review-form">
                ...
                <textarea
                  className="paper-review-input font-source-sans"
              ...
              {reviewsLoading ? (
                ...
                <p className="paper-reviews-empty font-open-sans">
                    ...
                    >
                      <div className="paper-review-header">
                        <div className="paper-review-author">
                          <div className="paper-review-avatar font-poppins">
                        ...
                        <div className="paper-review-meta">
                          <span className="paper-review-date font-mono">
                            {new Date(
                              review.created_at
                            ).toLocaleDateString()}
                          </span>
                      ...
                      {review.comment && (
                        <p className="paper-review-comment font-open-sans">
                          {review.comment}
                        </p>
                      )}
                    </div>
