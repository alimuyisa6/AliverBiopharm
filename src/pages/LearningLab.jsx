...
export default function LearningLab() {
    ...
    return (
      ...
      >
        <div className="lab-locked-screen">
          ...
          <button className="lab-locked-btn" onClick={() => navigate('/login')}>
    ...
    return (
      ...
      >
        <div className="lab-page-header">
          <button className="lab-back-btn" onClick={() => navigate('/#learning-lab')}>
      ...
      default:
        return (
          <div className="lab-empty-state">
            ...
            <button className="lab-back-btn" onClick={() => navigate('/lab')}>Back to Lab</button>
          </div>
        );
    }
  };
  ...
  return (
    ...
    >
      <div className="lab-page-header">
        <button className="lab-back-btn" onClick={() => navigate('/lab')}>
