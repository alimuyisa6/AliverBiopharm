...
// ========== GLOBAL STATE (matching original script) ==========
...
function HomePage() {
  ...
  function initPdfLibrary() {
    ...
    document.getElementById('pdf-preview-back-btn').addEventListener('click', () => {
      ...
      <div id="pdf-preview-modal" className="pdf-preview-modal">
        <div className="pdf-preview-content">
          <div className="pdf-preview-header">
            ...
            <button className="pdf-preview-close" id="pdf-preview-close">&times;</button>
          </div>
