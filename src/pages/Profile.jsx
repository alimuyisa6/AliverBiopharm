...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    async function loadProfileMeta() {
      try {
        ...
        if (!cancelled) setProfileMetaError(err.message || 'We couldn\u2019t load your profile details. Please try again.');
      }
    }
  ...
  async function handleProfileSubmit(e) {
    ...
    try {
      ...
      setProfileError(err.message || 'We couldn\u2019t update your profile. Please try again.');
    } finally {
  ...
  async function handlePasswordSubmit(e) {
    ...
    try {
      ...
      setPasswordError(err.message || 'We couldn\u2019t change your password. Please try again.');
    } finally {
  ...
  async function handleRequestLevelChange(e) {
    ...
    try {
      ...
      setLevelReqMessage('Your level change request has been submitted and is pending review.');
      setLevelReqTrack('');
      setLevelReqReason('');
    } catch (err) {
      setLevelReqMessage(err.message || 'We couldn\u2019t submit your request. Please try again.');
    } finally {
  ...
  const memberSinceRaw = user?.created_at || profileMeta?.created_at;
        ...
        >
          <div className="profile-card profile-card--green">
            ...
            {!isTeacher || (isTeacher && profileMeta?.approved_track !== 'ALL') ? (
              <p className="profile-change-hint" style={{ marginTop: '0.75rem' }}>
                To switch your active {classLabel.toLowerCase()}, use the class switcher in the site header.
              </p>
            ) : null}
              ...
              <>
                ...
                <div className="profile-change-section">
                  ...
                  <p className="profile-change-hint">
                    Moving to a different level (O-Level, A-Level, Pharmacy) requires admin approval. Your class or programme within the new level will be assigned automatically once approved.
                  </p>
                  ...
                  <form onSubmit={handleRequestLevelChange} className="profile-change-form">
                    ...
                    <button
                      ...
                      disabled={levelReqLoading || !levelReqTrack || !levelReqReason.trim()}
                    >
                      {levelReqLoading ? (
                        <>
