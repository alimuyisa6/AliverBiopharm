...
export default function BioRecall() {
  ...
  async function loadUserProgress() {
    ...
    try {
      ...
      if (dash) {
        ...
        setStreakDays(
          dash.current_streak || 0
        );

        setRankTitle(
          dash.rank_title || 'Beginner'
        );
  ...
  async function handleReviewConfidence(
    confidence
  ) {
  ...
  async function handleSessionConfidence(
    confidence
  ) {
   ...
   * Dynamic title.
   *
   * No hardcoded product/page name is
   * inserted into the title.
   *
   * The strongest available level/content
   * metadata is used.
   */

  const dynamicPageTitle =
    levelMeta?.recall_title ||
    levelMeta?.page_title ||
    levelName ||
    levelMeta?.display_name ||
    displayName ||
    '';
  ...
  /*
   * Optional dynamic supporting text.
   *
   * These are only used if your API already
   * supplies the values.
   */

  const dynamicPageDescription =
    levelMeta?.recall_description ||
    levelMeta?.description ||
    '';


  const dynamicEyebrow =
    levelMeta?.recall_label ||
    levelMeta?.label ||
    '';


  const dynamicActionLabel =
    levelMeta?.recall_action_label ||
      ...
      <div className="section recall-page-section">
        ...
        <header className="recall-header">
          ...
          {dynamicPageDescription && (
            <p className="recall-page-description font-source-sans">
              {dynamicPageDescription}
            </p>
          )}
                ...
                <>
                  ...
                  <div className="grid grid-cols-3 recall-cards-grid">
                    ...
                    <Card>
                      ...
                      <div className="recall-stat-card-inner">
                        ...
                        <Icon
                          name="trophy"
                          className="recall-stat-card-icon is-warm"
                        />

                        <h3 className="recall-stat-card-heading font-poppins">
                          XP Progress
                        </h3>
                    ...
                    <Card>
                      ...
                      <div className="recall-stat-card-inner">
                        ...
                        <Icon
                          name="bullseye"
                          className="recall-stat-card-icon is-primary"
                        />
                    ...
                    <Card>
                      ...
                      <div className="recall-stat-card-inner">
                        ...
                        <Icon
                          name="trophy"
                          className="recall-stat-card-icon is-accent"
                        />
                          ...
                          ([topic, mastery]) => (
                            ...
                            <Card key={topic}>
                              ...
                              <div className="recall-topic-card-inner">
                                ...
                                <Icon
                                  name="book-open"
                                  className="recall-topic-card-icon"
                                />

                                <h4 className="recall-topic-card-heading font-poppins">
                                  {topic}
                                </h4>
                                ...
                                <p className="recall-topic-card-pct font-mono">
                                  {Math.round(mastery)}%
                                </p>
                  ...
                  <div className="recall-leaderboard-section">
                    ...
                    {leaderboard.length === 0 ? (
                      ...
                      <p className="recall-leaderboard-empty font-open-sans">
                      ...
                      leaderboard.map(
                        (entry, index) => (
                          ...
                          <div
                            ...
                            className="card recall-leaderboard-row"
                          >

                            <span
                              className={`recall-rank font-mono ${rankClass(index)}`}
                            >
                              #{index + 1}
                            </span>
                            ...
                            <span className="badge badge-primary font-comfortaa">
                              Level {entry.recall_level}
                            </span>
