...
const strengthLabels = {
  ...
  strong: 'Close Match',
  developing: 'Needs Review'
};

const strengthDescriptions = {
  excellent: 'You\'ve mastered this concept. The answer matches exactly.',
  strong: 'Correct meaning, minor spelling variation accepted.',
  developing: 'Not quite. Review the correct answer and try again later.'
};
...
function BioRecall() {
    ...
    return (
      <div className="dashboard-grid">
        ...
        <div className="dashboard-card" style={{ cursor: 'pointer' }} onClick={toggleSound}>
          <div className="card-title">
            {soundEnabled ? <FaVolumeUp size="2.5rem" color="var(--primary)" /> : <FaVolumeMute size="2.5rem" color="#999" />}
            Sound Effects
          </div>
  ...
  const renderFeedback = () => {
    ...
    const label = (strength_meaning && strength_meaning.label) || strengthLabels[strength] || strength;
    const description = (strength_meaning && strength_meaning.description) || strengthDescriptions[strength] || '';
    const color = strengthColors[strength] || 'var(--primary)';
    return (
