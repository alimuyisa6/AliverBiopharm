...
export async function getResources({ unit_id, category } = {}) {
  const params = {};
...
export async function saveReadingProgress(noteId, scrollPercentage, scrollPosition, timeSpent, completed = false) {
  return apiCall('notes', 'save_progress', { note_id: noteId, scroll_percentage: scrollPercentage, scroll_position: scrollPosition, time_spent: timeSpent, completed });
}
...
export async function getQuizBlock(unitId, blockNumber) { return getRequest('quiz', 'get_quiz_block', { unit_id: unitId, block_number: blockNumber }); }
export async function checkDailyRetry(unitId, blockNumber) { return getRequest('quiz', 'check_daily_retry', { unit_id: unitId, block_number: blockNumber }); }
...
export async function getPastPapers(filters = {}) {
  ...
  return getRequest('past-papers', 'get_papers', params);
}
...
export async function getFlashcards({ unit_id } = {}) {
  const params = {};
  if (unit_id) params.unit_id = unit_id;
  return getRequest('flashcards', 'list', params);
}
export async function getFlashcardDecks({ unit_id } = {}) {
  const params = {};
  if (unit_id) params.unit_id = unit_id;
...
export async function getFlashcardOnboardingState() { return getRequest('flashcards', 'onboarding_state'); }
...
export async function saveFlashcardOnboarding(payload) { return apiCall('flashcards', 'save_onboarding', payload); }
export async function resetFlashcardOnboarding() { return apiCall('flashcards', 'reset_onboarding', {}); }
export async function startFlashcardSession(deckId, mode = 'flip') { return apiCall('flashcards', 'start_session', { deck_id: deckId, mode }); }
export async function updateFlashcardSession(sessionId, cardId, correct, currentIndex) {
  return apiCall('flashcards', 'update_session', { session_id: sessionId, card_id: cardId, correct, current_index: currentIndex });
}
export async function completeFlashcardSession(sessionId) { return apiCall('flashcards', 'complete_session', { session_id: sessionId }); }
export async function createFlashcardDeck(title, description, category, unit_id, difficulty_confidence, card_types, cards) {
  return apiCall('flashcards', 'create_deck', { title, description, category, unit_id, difficulty_confidence, card_types, cards });
}
...
export async function checkFlashcardAnswer(flashcardId, userAnswer, checkType = 'answer') { return apiCall('flashcards', 'check_answer', { flashcard_id: flashcardId, user_answer: userAnswer, check_type: checkType }); }
...
export async function startQuizSession(unitId, blockNumber, state = {}) { return apiCall('quiz', 'quiz_start_session', { unit_id: unitId, block_number: blockNumber, state }); }
export async function trackTabSwitch(unitId, blockNumber) { return apiCall('quiz', 'quiz_tab_switch', { unit_id: unitId, block_number: blockNumber }); }
export async function submitQuizWithSession(unitId, blockNumber, answers, timeTaken) { return apiCall('quiz', 'quiz_submit_with_session', { unit_id: unitId, block_number: blockNumber, answers, time_taken: timeTaken }); }
...
export async function getClassroomRoom(room_id) { return getRequest('classroom', 'room', { room_id }); }
export async function getClassroomMessages(room_id) { return getRequest('classroom', 'messages', { room_id }); }
export async function getClassroomParticipants(room_id) { return getRequest('classroom', 'participants', { room_id }); }
...
export async function getClassroomOnboardingStatus() { return getRequest('classroom', 'onboarding_status'); }
export async function saveClassroomOnboarding(payload) { return apiCall('classroom', 'save_onboarding', payload); }
export async function joinClassroom(room_id) { return apiCall('classroom', 'join', { room_id }); }
export async function leaveClassroom(room_id) { return apiCall('classroom', 'leave', { room_id }); }
export async function sendClassroomMessage(room_id, message) { return apiCall('classroom', 'send_message', { room_id, message }); }
export async function raiseHand(room_id, raise) { return apiCall('classroom', 'raise_hand', { room_id, raise }); }
export async function createClassroom(payload) { return apiCall('classroom', 'create', payload); }
export async function applyAsTutor(level, class_name, subjects, qualifications, experience) { return apiCall('classroom', 'tutor_apply', { level, class_name, subjects, qualifications, experience }); }
...
export async function globalSearch(query) { return getRequest('search', 'global', { q: query }); }
...
export async function updateContentGuideImage(level, className, imageUrl, fallbackColor, altText) {
  return apiCall('contentguide', 'image', { level, class_name: className, image_url: imageUrl, fallback_color: fallbackColor, alt_text: altText });
}
...
export async function uploadUserFile(formData) { return apiCall('upload', 'file', formData, 'POST', true); }
