...
export async function listQuizTopics() { return getRequest('quiz', 'list_quiz_topics'); }
...
export async function checkQuizAnswer({ unit_id, block_number, question_id, selected_option }) { return apiCall('quiz', 'quiz_check_answer', { unit_id, block_number, question_id, selected_option }); }
