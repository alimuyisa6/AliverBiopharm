...
export async function getFlashcardDecks(unitId) { return getRequest('flashcards', 'list', { unit_id: unitId }); }
...
export async function getActiveFlashcardSession(deckId) { return getRequest('flashcards', 'active_session', { deck_id: deckId }); }
...
export async function submitRecallAnswer(sessionId, questionId, answer) { return apiCall('recall', 'answer', { session_id: sessionId, question_id: questionId, user_answer: answer }); }
...
export async function getClassroomTopics(groupId) { return getRequest('classroom', 'topics', { group_id: groupId }); }
export async function listClassrooms(unitId) { return getRequest('classroom', 'list', { unit_id: unitId }); }
...
export async function getOnboardingStatus() { return getRequest('classroom', 'onboarding_status'); }
export async function saveOnboarding(payload) { return apiCall('classroom', 'save_onboarding', payload); }
...
export async function saveProfileOnboarding(payload) { return apiCall('profile', 'save_onboarding', payload); }
export async function requestLevelChange(track, className, reason) { return apiCall('profile', 'request_level_change', { requested_track: track, requested_class: className, reason }); }
...
export async function getNotifications() { return getRequest('recall', 'notifications'); }
...
export async function getNotificationPrefs() { return getRequest('recall', 'notification_prefs'); }
export async function updateNotificationPrefs(prefs) { return apiCall('recall', 'notification_prefs_update', { preferences: prefs }); }
