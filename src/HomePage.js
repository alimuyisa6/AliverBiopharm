    ...
    <>
        ...
        <div className="carousel-slide active" style={{ background: 'linear-gradient(135deg,#0a4f4f,#0e7070)' }}>
          <div className="slide-overlay">
            ...
            <a href="#courses" className="btn-primary">
              <i className="fa-solid fa-arrow-right" aria-hidden="true"></i> Explore Resources
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="mood-check" className="section reveal" style={{ paddingTop: '20px', paddingBottom: '20px' }} aria-label="How are you feeling?">
        <div className="mood-section">
          ...
          <div id="mood-message-form" style={{ display: 'none', textAlign: 'center' }}>
            ...
            ></textarea>
            <br />
            <button className="btn-primary" id="mood-submit-btn" style={{ marginTop: '8px', fontSize: '.8rem', padding: '8px 20px' }}>
      ...
      <section id="team" className="section reveal" aria-label="Faculty">
        ...
        <div className="grid-3" id="team-grid">
          <p style={{ textAlign: 'center', gridColumn: '1/-1', color: 'var(--clr-text-dim)' }}>Loading…</p>
        </div>
      </section>
      ...
      <section id="courses" className="section reveal" aria-label="Learning resources">
        ...
        <p className="section-subtitle">
          Browse our comprehensive library of biology and pharmacy materials. Download notes, past papers, lab manuals, and study guides curated by subject experts.
        </p>
        <div className="filter-bar">
          <div className="filter-bar-inner">
            <button className="filter-toggle-btn" id="filter-toggle-btn" aria-expanded="false">
              <i className="fa-solid fa-filter" aria-hidden="true"></i> Filter Resources <i className="fa-solid fa-chevron-down" id="filter-chevron" aria-hidden="true"></i>
            </button>
            <div className="filter-dropdown" id="filter-dropdown" style={{ display: 'none' }}>
              ...
              <div className="filter-accordion">
                <button className="filter-accordion-btn" data-filter="level" aria-expanded="false">
                  <span>Level</span>
                  <span className="filter-selected" id="selected-level">All Levels</span>
              ...
              <div className="filter-accordion">
                <button className="filter-accordion-btn" data-filter="category" aria-expanded="false">
                  <span>Category</span>
                  <span className="filter-selected" id="selected-category">All Categories</span>
                  <i className="fa-solid fa-chevron-down" aria-hidden="true"></i>
                </button>
      ...
      <section id="flashcards" className="section reveal" aria-label="Flashcards">
        ...
        <p className="section-subtitle">
          Active recall is the most effective way to retain complex scientific concepts. Flip each card to reveal detailed answers and mark your progress.
        </p>
        ...
        <p className="keyboard-hint">
          <i className="fa-regular fa-keyboard"></i> Keyboard: ← → navigate | Space flip | 1-3 rate difficulty
        </p>
      </section>
          ...
          <div style={{ marginBottom: '30px', paddingLeft: '20px' }}>
            ...
            <h2
              ...
              style={{
                ...
                margin: 0,
                background: 'linear-gradient(135deg, #e67e22, #b8873a, #0ab5b5)',
            ...
            <p className="section-subtitle" style={{ textAlign: 'left', margin: '8px 0 0 0', maxWidth: '600px' }}>
              Access comprehensive PDF resources for Biology and Pharmacy. Preview before downloading.
            </p>
          </div>
          <div
            className="pdf-main-container"
            id="pdf-main-container"
            style={{ background: 'var(--clr-navy-card)', backdropFilter: 'blur(12px)', borderRadius: '20px', overflow: 'hidden' }}
          >
            <div
              className="pdf-level-bar"
              id="pdf-level-bar"
              style={{
                display: 'flex',
                ...
                borderBottom: '1px solid var(--clr-border-glow)',
                background: 'rgba(0,0,0,0.02)',
              }}
            >
              <button
                className="pdf-level-btn active"
                data-level="O-Level"
                style={{
                  padding: '10px 28px',
                  borderRadius: '50px',
            ...
            <div className="pdf-content-wrapper" id="pdf-content-wrapper" style={{ display: 'flex', minHeight: '520px' }}>
              ...
              <div
                className="pdf-subtopics-column"
                id="pdf-subtopics-column"
                style={{
                  width: '280px',
                  minWidth: '280px',
                  background: 'rgba(0,0,0,0.03)',
                  borderLeft: '1px solid var(--clr-border-glow)',
                  display: 'flex',
                  flexDirection: 'column',
                }}
              >
                <div
                  className="pdf-subtopics-header"
                  style={{
                    padding: '18px 16px',
                    fontFamily: "'Poppins',sans-serif",
                    fontSize: '0.85rem',
                    ...
                    borderBottom: '2px solid var(--clr-magenta)',
                    textAlign: 'center',
                    background: 'rgba(0,0,0,0.02)',
                  }}
                >
                ...
                <div className="pdf-subtopics-list" id="pdf-subtopics-list" style={{ flex: 1, overflowY: 'auto', padding: '12px', maxHeight: '540px' }}>
                  <p className="pdf-subtopics-placeholder" style={{ textAlign: 'center', color: 'var(--clr-text-dim)', fontSize: '0.85rem', padding: '30px 20px' }}>
                    Select a level to view topics
                  </p>
                </div>
              </div>
            </div>
        ...
        <div id="pdf-preview-modal" className="pdf-preview-modal active">
          <div className="pdf-preview-content">
            <div className="pdf-preview-header">
              ...
              <button className="pdf-preview-close" id="pdf-preview-close" onClick={() => setPdfModalOpen(false)}>
                &times;
              </button>
            </div>
            ...
            <div className="pdf-preview-footer">
              <button className="pdf-preview-download-btn" id="pdf-preview-download-btn">
                Download PDF
              </button>
              <button className="pdf-preview-back-btn" id="pdf-preview-back-btn" onClick={() => setPdfModalOpen(false)}>
                Back to Library
              </button>
            </div>
          </div>
      ...
      <section id="notes-section" className="section-wrapper" style={{ margin: '60px 0', padding: '0 20px' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ marginBottom: '30px', paddingLeft: '20px' }}>
            ...
            <p className="section-subtitle" style={{ textAlign: 'left', margin: '8px 0 0 0', maxWidth: '600px' }}>
              Comprehensive study notes for Biology and Pharmacy. Structured by level, topic, and subtopic for easy learning.
            </p>
          </div>
      ...
      <section id="pricing" className="section alt-bg reveal" aria-label="Pricing">
        ...
        <p className="section-subtitle">
          Choose the plan that fits your learning journey. All plans include access to our complete resource library with regular updates.
        </p>
      ...
      <section id="blog" className="section alt-bg reveal" aria-label="Blog">
        ...
        <p className="section-subtitle">
          Stay informed with the latest developments in biology, pharmacy, and life sciences from our expert contributors.
        </p>
      ...
      <section id="faq" className="section reveal" aria-label="FAQ">
        ...
        <p className="section-subtitle">
          Quick answers to common questions about our platform, courses, resources, and membership options.
        </p>
      ...
      <section id="contact" className="section alt-bg reveal" aria-label="Contact">
        ...
        <div className="grid-2">
          <form id="contact-form" noValidate style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            <div>
              <label className="f-label" htmlFor="contact-name">FULL NAME</label>
              <input type="text" className="f-input" id="contact-name" placeholder="Your full name" required autoComplete="name" />
            </div>
            <div>
              <label className="f-label" htmlFor="contact-email">EMAIL ADDRESS</label>
              <input type="email" className="f-input" id="contact-email" placeholder="you@institution.edu" required autoComplete="email" />
            </div>
            <div>
              <label className="f-label" htmlFor="contact-subject">SUBJECT</label>
              <input type="text" className="f-input" id="contact-subject" placeholder="Subject" required />
            </div>
            <div>
              <label className="f-label" htmlFor="contact-message">MESSAGE</label>
              <textarea className="f-input" id="contact-message" placeholder="Your message" style={{ minHeight: '110px', resize: 'vertical' }} required></textarea>
            </div>
      ...
      <section className="section reveal" aria-label="Newsletter">
        ...
        <p className="section-subtitle">
          Join our community of learners. Get weekly insights, study tips, and new resource alerts delivered to your inbox.
        </p>
        <form id="newsletter-form">
          <div className="newsletter-box">
            ...
            <button type="submit">
              Subscribe <i className="fa-solid fa-paper-plane" aria-hidden="true"></i>
            </button>
          </div>
        </form>
      </section>
      ...
      <a href="#pricing" className="sticky-cta">
        <i className="fa-solid fa-rocket" aria-hidden="true"></i> Start Learning
      </a>
