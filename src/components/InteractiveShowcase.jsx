...
const InteractiveShowcase = () => {
  ...
  const isAutoDemoActiveRef = useRef(true);
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      if (apiCache.notes && apiCache.papers && apiCache.quiz && apiCache.flashcards && apiCache.continue) {
        ...
        setContinueReadingData(apiCache.continue);
        setIsLoading(false);
        return;
      }
      ...
      try {
        ...
        apiCache.notes = notesRes || [];
        apiCache.papers = papersRes?.papers || [];
        apiCache.quiz = quizRes || [];
        apiCache.flashcards = flashcardsRes || [];
        apiCache.continue = continueRes || [];
  ...
  }, [expandedFeature, isLoading, previewData]);
