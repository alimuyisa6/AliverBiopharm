  ...
  return (
    <div className="profile-picture-upload">
      ...
      <div style={{ display: 'flex', gap: 'var(--space-2)', marginTop: 'var(--space-3)' }}>
        ...
        <input ref={fileInputRef} type="file" accept="image/jpeg,image/png,image/webp,image/gif" onChange={handleUpload} style={{ display: 'none' }} />
      </div>
      {error && <div style={{ color: 'var(--error)', fontSize: 'var(--text-xs)', marginTop: 'var(--space-2)' }}>{error}</div>}
    </div>
  );
}
